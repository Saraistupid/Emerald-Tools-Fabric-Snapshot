...
public class IronBow extends RangedWeaponItem {
	  public IronBow(Item.Settings item$Settings_1) {
		    ...
		    addPropertyGetter(new Identifier("pull"), (itemStack_1, world_1, livingEntity_1) -> {
		          ...
		          if (livingEntity_1.getActiveItem().getItem() != Main.IRON_EMERALD_BOW) {
		            return 0.0F;
		          }
		  ...
		  public void onStoppedUsing(ItemStack itemStack_1, World world_1, LivingEntity livingEntity_1, int int_1) {
		    ...
		    if (!world_1.isClient) {
              ...
              projectileEntity_1.setDamage(projectileEntity_1.getDamage() * 0.6D + 0.6D);
		      if (float_1 == 1.0F) {
