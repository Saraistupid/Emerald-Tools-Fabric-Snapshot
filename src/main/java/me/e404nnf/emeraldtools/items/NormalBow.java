...
public class NormalBow extends RangedWeaponItem {
	  public NormalBow(Item.Settings item$Settings_1) {
		    ...
		    addPropertyGetter(new Identifier("pull"), (itemStack_1, world_1, livingEntity_1) -> {
		          ...
		          if (livingEntity_1.getActiveItem().getItem() != Main.EMERALD_BOW) {
		            return 0.0F;
		          }
          ...
          projectileEntity_1.setDamage(projectileEntity_1.getDamage() * 0.5D + 0.5D);
		      if (float_1 == 1.0F) {
